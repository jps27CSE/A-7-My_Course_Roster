...
const Course = () => {
  return (
    <div className="w-[315px]  h-[402px] drop-shadow-2xl rounded-lg  bg-slate-200">
      <div>
        <img
      ...
      <button className="btn mt-2 w-[280px] h-[40px] bg-[#2F80ED] flex mx-auto text-white text-center hover:bg-slate-500">
        Select
      </button>
    </div>
  );
